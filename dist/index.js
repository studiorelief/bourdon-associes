...
(() => {
  ...
  // src/utils/animations/parallax.ts
  function parallaxHomeDescription() {
    gsapWithCSS.registerPlugin(ScrollTrigger2);
  ...
  function parallaxExpertiseDescription() {
    gsapWithCSS.registerPlugin(ScrollTrigger2);
  ...
  // src/utils/attributes/filters.ts
  function teamFilters() {
    ...
    const updateAllButtonState = () => {
      const hasActiveField = Array.from(radioFields).some(
        (field) => field.classList.contains("is-active-inputactive")
      );
      if (hasActiveField) {
  ...
  // src/utils/global/headingSlide.ts
  gsapWithCSS.registerPlugin(ScrollTrigger2);
    ...
    const debouncedResize = () => {
      ...
      resizeTimeout = window.setTimeout(() => {
        ...
        headingWrappers.forEach((wrapper) => {
          const headingTitle = wrapper.querySelector(".heading-title");
  ...
  // node_modules/.pnpm/@marker.io+browser@0.20.2/node_modules/@marker.io/browser/lib/esm/index.mjs
  var markerSDK = {
    loadWidget(params) {
      const knownParams = [
        "destination",
  ...
  function textLoop() {
    ...
    const playMarquee = () => {
      ...
      marqueeContentClone.style.marginLeft = `${gap}px`;
  ...
  // node_modules/.pnpm/swiper@11.2.6/node_modules/swiper/swiper-bundle.mjs
  var modules = [Virtual, Keyboard, Mousewheel, Navigation, Pagination, Scrollbar, Parallax, Zoom, Controller, A11y, History, HashNavigation, Autoplay, Thumb, freeMode, Grid, Manipulation, EffectFade, EffectCube, EffectFlip, EffectCoverflow, EffectCreative, EffectCards];
  Swiper.use(modules);

  // src/utils/global/swiper.ts
  function actualitesSwiper() {
